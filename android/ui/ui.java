...
/*
	...
	Преимущество в том, что можно создавать макет без редактирования xml.

	Совместим с Android 2.3.
	
	Чтобы определить макет ConstraintLayout нужно добавить к view горизонтальное или вертикальное ограничение. Ограничение в данном случае - это выравнивание или соединение относительно другого view. 
	...
	infer constraints- функция, которая сканирует макет, чтобы определить наиболее эффективный набор ограничений для всех представлений.
