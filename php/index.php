...
/*
    Если нужно преобразовать всё слово или его первую букву к верхнему регистру, то функции ucfirst и strtoupper не будут работать для русских слов. В таких случаях препочтительней использовать функцию mb_convert_case
*/

/*
    Если при работе с консолью openserver выпадает ошибка о том, что версия php не подходит.

    Идём в переменные среды и меняем путь к модулю php: C:\OpenServer\modules\php\PHP-7.0-x64;
*/